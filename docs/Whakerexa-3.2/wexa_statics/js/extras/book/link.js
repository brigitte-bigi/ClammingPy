...
export class Link {
    ...
    /**
     * What a query looks like in an address. A search is built by the
     * bibliography itself, and is the only link that is always available.
     */
    static SEARCH_MARKS = ['?q=', '&q='];
    ...
    kind() {
        ...
        if (Link.#containsOneOf(address, Link.SEARCH_MARKS) === true) {
