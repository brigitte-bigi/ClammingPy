...
ClammingPy requires Whakerexa >= 4.0.0 to be installed; it can be downloaded from: <https://whakerexa.sourceforge.io>.
...
2. `docs`: the documentation of clamming library in HTML
...
>> >  # Options for HTML exportation
>> > html_export = clamming.ExportOptions()
>> > html_export.wexa_statics = './Whakerexa-current/wexa_statics'
>> > html_export.software = 'ClammingPy ' + clamming.__version__
...
For the local use, download and unpack Whakerexa >= 4.0.0 into the `docs` folder.
...
> Version 2.1. 2025. <https://hal.science/hal-04392103>
